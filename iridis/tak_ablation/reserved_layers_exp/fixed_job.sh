#!/bin/bash
#SBATCH --job-name=reserved_27_ablation_test
...
N_LAYER=27        # Paper uses 24 for Table 2 ablation
N_REPEAT=5        # Number of block repeats
ITERATIONS=300  # Training steps
...
CKPT_FREQ=10    # Save every 2000 steps
...
TRAIN_ARGS=(
    ...
    --exp_name "Deadlock_RAM_test_cotformer_full_depth_27_layer_test_bs${BATCH_SIZE}x${ACC_STEPS}_seqlen256"
    --use_pretrained auto
    --wandb
